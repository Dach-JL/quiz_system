        ...
        <div className="min-h-screen bg-gradient-to-b from-white to-slate-50 dark:from-slate-950 dark:to-slate-900 pb-24 transition-colors duration-500">
            <main className="mx-auto max-w-4xl px-6 lg:px-8 py-12">
                ...
                <div className="mb-10 flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 dark:text-white">Create New Quiz</h1>
                        <p className="text-slate-600 dark:text-slate-400 text-sm mt-0.5">Add questions and configure settings</p>
                    </div>
                </div>
                                                ...
                                                {Array.isArray(q.options) && q.options.map((opt, oIndex) => (
                                                    <div key={oIndex} className="space-y-2">
                                                        ...
                                                        <input
                                                            ...
                                                            placeholder={`Answer option ${String.fromCharCode(65 + oIndex)}`}
